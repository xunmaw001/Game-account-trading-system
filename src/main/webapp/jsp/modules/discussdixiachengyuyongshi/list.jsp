...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">地下城与勇士评论表</h4>
	...
	<script >
        ...
        function getDataList() {
			http("discussdixiachengyuyongshi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("discussdixiachengyuyongshi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"discussdixiachengyuyongshi");
