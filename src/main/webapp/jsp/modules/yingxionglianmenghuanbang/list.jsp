...
<body>
	...
	<script >
        ...
        function getDataList() {
			http("yingxionglianmenghuanbang/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item){
			...
			function sh(){
				...
				httpJson("yingxionglianmenghuanbang/update","POST",data,(res)=>{
					if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yingxionglianmenghuanbang/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"yingxionglianmenghuanbang");
