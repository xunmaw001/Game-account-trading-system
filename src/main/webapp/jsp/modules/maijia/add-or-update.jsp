...
<body>
				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/maijia/list.jsp">卖家</a>
							</li>
						</ul>
					</div>
					<div class="row">
									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<div id="chushengnianyueDate" class="input-append date form_datetime">
													<input id="chushengnianyue-input" name="chushengnianyue" size="15" type="text" readonly>
											...
											<div class="form-group">
												...
												<input id="qqzhanghao" name="qqzhanghao" class="form-control" placeholder="qq账号">
												</div>	
											<div class="form-group">
												<label>联系电话</label>
											...
											<div class="form-group">
												...
												<input id="jiatingdizhi" name="jiatingdizhi" class="form-control" placeholder="家庭地址">
												</div>	
											<div class="form-group">
												<label>认证照片</label>
												
													<img id="renzhengzhaopianImg" src="" width="100" height="100">
													<input name="file" type="file" id="renzhengzhaopianupload" class="form-control-file">
													<input name="renzhengzhaopian" id="renzhengzhaopian-input" type="hidden">
												</div>	
											<div class="form-group">
	...
	<script>
		...
		// 文件上传
		function upload(){
																																																																																		$('#renzhengzhaopianupload').fileupload({
						url: baseUrl + 'file/upload',
						headers:{ token: window.sessionStorage.getItem("token")},
						dataType: 'json',
						done: function (e, data) {						
							document.getElementById('renzhengzhaopian-input').setAttribute('value',baseUrl+"upload/"+data.result.file);
							if(document.getElementById('renzhengzhaopianFileName') != null){
								document.getElementById('renzhengzhaopianFileName').innerHTML = data.result.file +"";
							}						
							$("#renzhengzhaopianImg").attr("src",baseUrl+"upload/"+data.result.file);
						}
					});
																							}  
		// 表单提交
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("maijia/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dateTimePick(){
			$.fn.datetimepicker.dates['zh-CN'] = { 
		            ...
		            meridiem: ["上午", "下午"]
																																							...
																																							$("#chushengnianyueDate").datetimepicker({ 
					minView: "month",
					autoclose: true,
					format:'yyyy-mm-dd',
					language:'zh-CN',
					...
					for(var xingbieCount = 0; xingbieCount < xingbieOptions.length;xingbieCount++){
						if(xingbieOptions[xingbieCount].getAttribute('value') == ruleForm.xingbie){
							xingbieOptions[xingbieCount].setAttribute('selected','selected');
																...
																$("#chushengnianyue-input").val(ruleForm.chushengnianyue);
																$("#qqzhanghao").val(ruleForm.qqzhanghao);	
																...
																$("#jiatingdizhi").val(ruleForm.jiatingdizhi);	
																$("#renzhengzhaopian-input").val(ruleForm.renzhengzhaopian);
											
																				$("#shhf").val(ruleForm.shhf);	
									}
		//图片显示
		function showImg(){
																																																																																		var renzhengzhaopianFileName = "\"" + ruleForm.renzhengzhaopian + "\"";
					$("#renzhengzhaopianImg").attr("src",ruleForm.renzhengzhaopian);
																							}		
       //跨表
								...
								for(var xingbieCount = 0; xingbieCount < xingbieOptions.length;xingbieCount++){
									if(xingbieOptions[xingbieCount].getAttribute('value') == res.data.xingbie){
										xingbieOptions[xingbieCount].setAttribute('selected','selected');
												...
												if(res.data != null && res.data != '' && res.data.chushengnianyue != null && res.data.chushengnianyue != ''){

															$("#chushengnianyue-input").val(res.data.chushengnianyue);
								$('#chushengnianyueFileName').val(res.data.chushengnianyue)
													}
												if(res.data != null && res.data != '' && res.data.qqzhanghao != null && res.data.qqzhanghao != ''){

															$("#qqzhanghao").val(res.data.qqzhanghao);
													}
												...
												if(res.data != null && res.data != '' && res.data.jiatingdizhi != null && res.data.jiatingdizhi != ''){

															$("#jiatingdizhi").val(res.data.jiatingdizhi);
													}
												if(res.data != null && res.data != '' && res.data.renzhengzhaopian != null && res.data.renzhengzhaopian != ''){

															$("#renzhengzhaopianImg").attr("src",res.data.renzhengzhaopian);
								$("#renzhengzhaopian-input").val(res.data.renzhengzhaopian);
													}
