									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="nianling" v-model="ruleForm.nianling" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="dianhuahaoma" v-model="ruleForm.dianhuahaoma" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>邮箱号码</label>
																								
																								<input id="youxianghaoma" v-model="ruleForm.youxianghaoma" readonly>
																							</div>
