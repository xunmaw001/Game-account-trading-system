...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">地下城私信聊天</h4>
	...
	<script >
		...
		var tableName = "dixiachengsixinliaotian";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("dixiachengsixinliaotian/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item){
			...
			btnGroup.setAttribute("class","form-button-action");
				...
				crossBtn.setAttribute("onclick","crossTable(" + item.id +",\"dixiachengsixinhuifu\")");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("dixiachengsixinliaotian/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("dixiachengsixinliaotian" + colName,"GET",{
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"dixiachengsixinliaotian");
