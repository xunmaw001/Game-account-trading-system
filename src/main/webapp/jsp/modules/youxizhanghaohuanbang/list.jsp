...
<body>
									...
									<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
										...
										<div class="col-sm-12">
											<div id="add-row_filter" class="dataTables_filter">
																																																						<label>卖家账号 <input type="text" id="maijiazhanghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
																																																																																																										...
																																																																																																										<label>游戏分类 <input type="text" id="youxifenleiSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="maijiazhanghaoTh" class="sorting" onclick="sort('maijiazhanghao')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">卖家账号</th>
																																																			...
																																																			<th id="youxifenleiTh" class="sorting" onclick="sort('youxifenlei')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">游戏分类</th>
																																																			<th id="youxiqufuTh" class="sorting" onclick="sort('youxiqufu')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">游戏区服</th>
																																																			<th id="dengluzhanghaoTh" class="sorting" onclick="sort('dengluzhanghao')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">登录账号</th>
																																																			<th id="denglumimaTh" class="sorting" onclick="sort('denglumima')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">登录密码</th>
																																																			<th id="bangdingshoujiTh" class="sorting" onclick="sort('bangdingshouji')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">绑定手机</th>
																																																			<th id="huanbangshoujiTh" class="sorting" onclick="sort('huanbangshouji')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">换绑手机</th>
																																																			
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">换绑截图</th>
																																																																	<th id="huanbangshijianTh" class="sorting" onclick="sort('huanbangshijian')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">换绑时间</th>
	...
	<script >
        ...
        function getDataList() {
			http("youxizhanghaohuanbang/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var dengluzhanghaoCell  = document.createElement('td');

												 dengluzhanghaoCell.innerHTML = item.dengluzhanghao;

                
													row.appendChild(dengluzhanghaoCell);
				
            				var denglumimaCell  = document.createElement('td');

												 denglumimaCell.innerHTML = item.denglumima;

                
													row.appendChild(denglumimaCell);
				
            				var bangdingshoujiCell  = document.createElement('td');

												 bangdingshoujiCell.innerHTML = item.bangdingshouji;

                
													row.appendChild(bangdingshoujiCell);
				
            				var huanbangshoujiCell  = document.createElement('td');

												 huanbangshoujiCell.innerHTML = item.huanbangshouji;

                
													row.appendChild(huanbangshoujiCell);
				
            				var huanbangjietuCell  = document.createElement('td');

								                  var huanbangjietuImg = document.createElement('img');
				  huanbangjietuImg.setAttribute('src',item.huanbangjietu);
				  huanbangjietuImg.setAttribute('height','100px');
				  huanbangjietuImg.setAttribute('width','100px');
				  huanbangjietuCell.appendChild(huanbangjietuImg);

				
													row.appendChild(huanbangjietuCell);
				
            				var huanbangshijianCell  = document.createElement('td');

												  huanbangshijianCell.innerHTML = item.huanbangshijian;

				
													row.appendChild(huanbangshijianCell);
			...
			function sh(){
				...
				httpJson("youxizhanghaohuanbang/update","POST",data,(res)=>{
					if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("youxizhanghaohuanbang/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"youxizhanghaohuanbang");
