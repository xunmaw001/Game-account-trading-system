	...
	<div class="form-box layui-form" lay-filter="layform">
		<div class="form-control form-content">
			...
			<div>
				...
				<div class="layui-form-item">
					<label class="layui-form-label">角色职业</label>
					<div class="layui-input-block">
						<input v-model="detail.jiaosezhiye" type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入角色职业" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="" placeholder="请输入购买日期" autocomplete="off" class="layui-input" id="goumairiqi">
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	var app = new Vue({
		...
		computed: {
			shifujine: {
				get: function () {
				return 0+parseFloat(this.detail.zhanghaojiage)+parseFloat(this.detail.shouxufei) || ''
				}
			},
		},
		updated() {
		...
		methods: {
			...
			onConfirmTap(){
				...
				addFun("dixiachengzhanghaogoumai", this.detail, (res) => {
					if(res&&res.code==0){
						alert("提交成功")
						window.history.go(-1)
					}
