...
<body>
										...
										<thead>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																													...
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">卖家回复</th>
																																																																	<th id="yonghumingTh" class="sorting" onclick="sort('yonghuming')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">用户名</th>
																																																			
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">用户留言</th>
	...
	<script >
		...
		var tableName = "sixinliaotianhuifu";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("sixinliaotianhuifu/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var maijiahuifuCell  = document.createElement('td');

												  if(item.maijiahuifu != null && item.maijiahuifu != "" && item.maijiahuifu.length >= 11){
				  	maijiahuifuCell.innerHTML = item.maijiahuifu.substring(0, 10) + "..."; 
				  }else{
				  	maijiahuifuCell.innerHTML = item.maijiahuifu;
				  }

				
													row.appendChild(maijiahuifuCell);
            				...
            				var yonghuliuyanCell  = document.createElement('td');

												  if(item.yonghuliuyan != null && item.yonghuliuyan != "" && item.yonghuliuyan.length >= 11){
				  	yonghuliuyanCell.innerHTML = item.yonghuliuyan.substring(0, 10) + "..."; 
				  }else{
				  	yonghuliuyanCell.innerHTML = item.yonghuliuyan;
				  }

				
													row.appendChild(yonghuliuyanCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("sixinliaotianhuifu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("sixinliaotianhuifu" + colName,"GET",{
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"sixinliaotianhuifu");
