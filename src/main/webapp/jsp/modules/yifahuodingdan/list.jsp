...
<body>
														...
														<thead>
															...
															<tr role="row">
																...
																<th id="discountpriceTh" class="sorting"
																	...
																	aria-controls="add-row" rowspan="1" colspan="1">折扣价格</th>
	...
	<%@ include file="../../static/toLogin.jsp"%>
		...
		function setDataRow(item) {
			...
			shouhuoBtn.setAttribute("class", "btn btn-warning btn-xs 修改");
