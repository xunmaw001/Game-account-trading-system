									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
												...
												<input type="hidden" id="maijiahuifu-input">
																																																																																																					...
																																																																																																					<div class="form-group">
												<label>用户回复</label>
												<script id="yonghuhuifuEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var yonghuhuifuUe = UE.getEditor('yonghuhuifuEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" id="yonghuhuifu-input">
											</div>
																																								</form>
										</div>
									</div>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yingxionglianmenghuifu/info/" + id,
		...
		function setContent(){
					...
					maijiahuifuUeditor.ready(function() {
						...
						maijiahuifuUeditor.setDisabled('fullscreen');
																			...
																			if(ruleForm.yonghuhuifu != null && ruleForm.yonghuhuifu != 'null' && ruleForm.yonghuhuifu != ''){
					var yonghuhuifuMes = '' + ruleForm.yonghuhuifu;
					var yonghuhuifuUeditor = UE.getEditor('yonghuhuifuEditor');
					yonghuhuifuUeditor.ready(function() {
						yonghuhuifuUeditor.setContent(yonghuhuifuMes);
						yonghuhuifuUeditor.setDisabled('fullscreen');
					});
				}
								}  
