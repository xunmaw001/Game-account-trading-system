...
public class YouxizhanghaohuanbangEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YouxizhanghaohuanbangEntity() {
		
	}
	
	public YouxizhanghaohuanbangEntity(T t) {
		try {
	 ...
	 * 设置：登录账号
	 */
	public void setDengluzhanghao(String dengluzhanghao) {
		this.dengluzhanghao = dengluzhanghao;
	}
	/**
	 * 获取：登录账号
	 */
	public String getDengluzhanghao() {
