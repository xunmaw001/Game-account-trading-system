		...
		<div class="container" id="app">
			<div class="loginBox">
				...
				<form id="loginForm">
					...
					<div class="input-wrapper">
						<label>游戏跨区:</label>
						<input v-model="youxikuaqu" type="text" name="" placeholder="请输入游戏跨区">
					</div>
					<div class="input-wrapper">
						<label>角色等级:</label>
					...
					<div class="input-wrapper">
						<label>角色职业:</label>
						<input v-model="jiaosezhiye" type="text" name="" placeholder="请输入角色职业">
					</div>
					<div class="input-wrapper">
						<label>账号价格:</label>
				...
				methods: {
					userRegister(){
						var data = {
							...
							"youxikuaqu": this.youxikuaqu,
							"jiaosedengji": this.jiaosedengji,
							"jiaosezhiye": this.jiaosezhiye,
						...
						register('dixiachengzhanghaogoumai', data, function(res){
							if(res.code==0){
								alert('注册成功')
