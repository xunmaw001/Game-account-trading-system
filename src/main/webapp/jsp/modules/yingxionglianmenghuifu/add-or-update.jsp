				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/yingxionglianmenghuifu/list.jsp">英雄联盟回复</a>
							</li>
						</ul>
					</div>
					<div class="row">
									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<textarea id="maijiahuifu" name="maijiahuifu" class="form-control" rows="5">
												</textarea>
											</div>	
											<div class="form-group">
												<label>用户名</label>
											...
											<div class="form-group">
												...
												<textarea id="yonghuhuifu" name="yonghuhuifu" class="form-control" rows="5">
												</textarea>
											</div>	
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("yingxionglianmenghuifu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				...
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yingxionglianmenghuifu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						setSelectOption();
						// 设置图片src
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#shangpinbianhao").val(ruleForm.shangpinbianhao);	
																...
																$("#maijiahuifu-input").val(ruleForm.maijiahuifu);
																$("#yonghuming").val(ruleForm.yonghuming);	
																$("#yonghuhuifu-input").val(ruleForm.yonghuhuifu);
									}
		//图片显示
		function showImg(){
																																								}		
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.maijiahuifu != null && res.data.maijiahuifu != ''){

															$("#maijiahuifu-input").val(res.data.maijiahuifu);
													}
												if(res.data != null && res.data != '' && res.data.yonghuming != null && res.data.yonghuming != ''){

															$("#yonghuming").val(res.data.yonghuming);
													}
												if(res.data != null && res.data != '' && res.data.yonghuhuifu != null && res.data.yonghuhuifu != ''){

															$("#yonghuhuifu-input").val(res.data.yonghuhuifu);
													}
											}
				});  
            }
