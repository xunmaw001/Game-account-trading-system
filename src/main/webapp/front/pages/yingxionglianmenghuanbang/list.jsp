			...
			<section class="page-header bg_img padding-tb">
				...
				<div class="container">
					<div class="page-header-content-area">
						<h4 class="ph-title">英雄联盟换绑列表</h4>
						<ul class="agri-ul">
							<li><a href="../../index.jsp">首页</a></li>
							<li><a class="active">英雄联盟换绑列表</a></li>
						</ul>
					</div>
				</div>
			</section>
			...
			methods: {
				...
				getList(searchname, searchval) {
					return new Promise((resolve) => {
						goodsList('yingxionglianmenghuanbang',this.page.page, this.page.limit, searchname, searchval, (res) => {
							if (res.code == 0) {
