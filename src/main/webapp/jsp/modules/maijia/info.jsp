									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="chushengnianyue" v-model="ruleForm.chushengnianyue" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>qq账号</label>
																								
																								<input id="qqzhanghao" v-model="ruleForm.qqzhanghao" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="jiatingdizhi" v-model="ruleForm.jiatingdizhi" readonly>
																							</div>
