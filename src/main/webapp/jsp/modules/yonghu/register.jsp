...
<div class="login">
	...
	<form method="post" id="registerForm">
														<input type="text" name="yonghuming" placeholder="用户名" />
																...
																<input type="text" name="nianling" placeholder="年龄" />
				
																							<input type="text" name="qqzhanghao" placeholder="qq账号" />
				
																<input type="text" name="dianhuahaoma" placeholder="电话号码" />
				
																<input type="text" name="youxianghaoma" placeholder="邮箱号码" />
				
																<input type="text" name="shenfenzhenghao" placeholder="身份证号" />
				
																<input type="text" name="jiatingdizhi" placeholder="家庭地址" />
