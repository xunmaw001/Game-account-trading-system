...
<html>
			...
			<section class="page-header bg_img padding-tb">
				...
				<div class="container">
					<div class="page-header-content-area">
						<h4 class="ph-title">游戏账号换绑列表</h4>
						<ul class="agri-ul">
							<li><a href="../../index.jsp">首页</a></li>
							<li><a class="active">游戏账号换绑列表</a></li>
						</ul>
					</div>
				</div>
			</section>
							...
							<div class="col-lg-3 col-md-7 col-12">
							    <aside>
							        <div class="widget widget-search">
							            ...
							            <form @submit.prevent="searchmaijiazhanghaoTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="maijiazhanghao" type="text" name="s" placeholder="请输入卖家账号">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							            <form @submit.prevent="searchyonghumingTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="yonghuming" type="text" name="s" placeholder="请输入用户名">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							            ...
							            <form @submit.prevent="searchyouxifenleiTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="youxifenlei" type="text" name="s" placeholder="请输入游戏分类">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							        </div>
							    </aside>
	...
	<script type="text/javascript">
		var app = new Vue({
			...
			methods: {
				searchmaijiazhanghaoTap(){
					this.page.page = 1
					this.searchname = "maijiazhanghao"
					this.searchval = this.maijiazhanghao
				...
				searchyouxifenleiTap(){
					this.page.page = 1
					this.searchname = "youxifenlei"
					this.searchval = this.youxifenlei
					this.getList(this.searchname, this.searchval)
				},
				onPageTap(url) {
				...
				getList(searchname, searchval) {
					return new Promise((resolve) => {
						goodsList('youxizhanghaohuanbang',this.page.page, this.page.limit, searchname, searchval, (res) => {
							if (res.code == 0) {
