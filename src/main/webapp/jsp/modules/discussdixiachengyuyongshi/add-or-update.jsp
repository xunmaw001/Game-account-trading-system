...
<body>
				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/discussdixiachengyuyongshi/list.jsp">地下城与勇士评论表</a>
							</li>
						</ul>
					</div>
					<div class="row">
	...
	<script>
		...
		var tableName = "discussdixiachengyuyongshi";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "discussdixiachengyuyongshi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("discussdixiachengyuyongshi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				...
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("discussdixiachengyuyongshi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						setSelectOption();
						// 设置图片src
		...
		function calculationSE(colName){
			//单列求和接口
			http("discussdixiachengyuyongshi"+colName,"GET",{
