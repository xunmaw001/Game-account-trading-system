	...
	<body>
		<div id="app">
			...
			<section class="product-section product-style2 padding-tb" style="padding-bottom: 0;">
				<div class="container">
					<div class="section-header">
						<h3>地下城与勇士</h3>
						<p @click="onPageTap('../dixiachengyuyongshi/list.jsp')">查看更多</p>
					</div>
					<div class="section-wrapper">
						<div class="row">
							<div class="col-lg-3 col-md-6 col-12" v-for="(item, i) in dixiachengyuyongshiList">
								<div class="product-item-2">
									<div class="product-inner">
										<div class="product-thumb" v-if="item.fengmiantupian">
											<img :src="item.fengmiantupian.split(',')[0]" alt="product">
										</div>
										<div class="product-content">
											<a :href="`javascript: onPageTap('../dixiachengyuyongshi/detail.jsp?id=${item.id}')`">
												<h5>{{item.zhanghaobiaoti}}</h5>
											</a>
											<div class="cart-option">
												<a :href="`javascript: onPageTap('../dixiachengyuyongshi/detail.jsp?id=${item.id}')`" class="lab-btn"><span>查看详情</span></a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="text-center">
							<a href="javascript: onPageTap('../dixiachengyuyongshi/list.jsp')" class="lab-btn"><span>查看更多</span></a>
						</div>
					</div>
				</div>
			</section>
			<section class="product-section product-style2 padding-tb" style="padding-bottom: 0;">
				<div class="container">
					<div class="section-header">
						<h3>英雄联盟</h3>
						<p @click="onPageTap('../yingxionglianmeng/list.jsp')">查看更多</p>
					</div>
					<div class="section-wrapper">
						<div class="row">
							<div class="col-lg-3 col-md-6 col-12" v-for="(item, i) in yingxionglianmengList">
								<div class="product-item-2">
									<div class="product-inner">
										<div class="product-thumb" v-if="item.fengmiantupian">
											<img :src="item.fengmiantupian.split(',')[0]" alt="product">
										...
										<div class="product-content">
											<a :href="`javascript: onPageTap('../yingxionglianmeng/detail.jsp?id=${item.id}')`">
												<h5>{{item.zhanghaobiaoti}}</h5>
											</a>
											<div class="cart-option">
												<a :href="`javascript: onPageTap('../yingxionglianmeng/detail.jsp?id=${item.id}')`" class="lab-btn"><span>查看详情</span></a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="text-center">
							<a href="javascript: onPageTap('../yingxionglianmeng/list.jsp')" class="lab-btn"><span>查看更多</span></a>
						</div>
					</div>
				</div>
			</section>
			<section class="product-section product-style2 padding-tb" style="padding-bottom: 0;">
				<div class="container">
					<div class="section-header">
						<h3>游戏账号</h3>
						<p @click="onPageTap('../youxizhanghao/list.jsp')">查看更多</p>
					</div>
					<div class="section-wrapper">
						<div class="row">
							<div class="col-lg-3 col-md-6 col-12" v-for="(item, i) in youxizhanghaoList">
								<div class="product-item-2">
									<div class="product-inner">
										<div class="product-thumb" v-if="item.fengmiantupian">
											<img :src="item.fengmiantupian.split(',')[0]" alt="product">
										...
										<div class="product-content">
											<a :href="`javascript: onPageTap('../youxizhanghao/detail.jsp?id=${item.id}')`">
												<h5>{{item.zhanghaobiaoti}}</h5>
											</a>
											<div class="cart-option">
												<a :href="`javascript: onPageTap('../youxizhanghao/detail.jsp?id=${item.id}')`" class="lab-btn"><span>查看详情</span></a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="text-center">
							<a href="javascript: onPageTap('../youxizhanghao/list.jsp')" class="lab-btn"><span>查看更多</span></a>
						</div>
					</div>
				</div>
			</section>
		...
		<script type="text/javascript">
			...
			var app = new Vue({
				...
				data: {
					banners: [],
					dixiachengyuyongshiList: [],
					yingxionglianmengList: [],
					youxizhanghaoList: [],
					news: [],
				},
				methods: {
				...
				created() {
					...
					recommend('dixiachengyuyongshi', false, (res) => {
						if (res.code == 0) {
							this.dixiachengyuyongshiList = res.data.list
						}
					})
					recommend('yingxionglianmeng', false, (res) => {
						if (res.code == 0) {
							this.yingxionglianmengList = res.data.list
						}
					})
					recommend('youxizhanghao', false, (res) => {
						if (res.code == 0) {
							this.youxizhanghaoList = res.data.list
						}
					})
				}
			})
