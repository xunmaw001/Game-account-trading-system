	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">留言板详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">留言板详情</a></li>
				</ul>
			</div>
		</div>
	</section>
						...
						<div class="row">
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									<h4>留言人id：{{detail.userid}}</h4>
									<h4>留言人用户名：{{detail.username}}</h4>
									<h4>留言内容：{{detail.content}}</h4>
									<h4>回复内容：{{detail.reply}}</h4>
