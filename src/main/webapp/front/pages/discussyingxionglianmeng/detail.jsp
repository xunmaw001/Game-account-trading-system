	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">英雄联盟评论表详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">英雄联盟评论表详情</a></li>
				</ul>
			</div>
		</div>
	</section>
...
<script type="text/javascript">
	var app = new Vue({
		...
		async created() {
			...
			if(typeof frontmenus == "object"){
				frontmenus.forEach(item => {
					if(item.menutable == "discussyingxionglianmeng"){
		...
		methods: {
			...
			getDetail(id){
				return new Promise((resolve) => {
					goodsInfo('discussyingxionglianmeng',id, (res) => {
			...
			getComments(){
				commentList("discussyingxionglianmeng", this.detail.id, (res) => {
					if(res&&res.code==0){
			...
			async onCommentTap(){
				...
				if(user){
					...
					addComment("discussyingxionglianmeng", data, (res) => {
						if(res&&res.code==0){
							alert("评论成功")
							this.getComments()
						}
