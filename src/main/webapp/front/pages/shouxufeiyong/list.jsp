...
<html>
			...
			<section class="page-header bg_img padding-tb">
				...
				<div class="container">
					<div class="page-header-content-area">
						<h4 class="ph-title">手续费用列表</h4>
						<ul class="agri-ul">
							<li><a href="../../index.jsp">首页</a></li>
							<li><a class="active">手续费用列表</a></li>
						</ul>
					</div>
				</div>
			</section>
							...
							<div class="col-lg-3 col-md-7 col-12">
							    <aside>
							        <div class="widget widget-search">
							            ...
							            <form @submit.prevent="searchjiagequjianTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="jiagequjian" type="text" name="s" placeholder="请输入价格区间">
	...
	<script type="text/javascript">
		var app = new Vue({
			...
			methods: {
				searchjiagequjianTap(){
					this.page.page = 1
					this.searchname = "jiagequjian"
					this.searchval = this.jiagequjian
				...
				getList(searchname, searchval) {
					return new Promise((resolve) => {
						goodsList('shouxufeiyong',this.page.page, this.page.limit, searchname, searchval, (res) => {
							if (res.code == 0) {
