	...
	<div class="form-box layui-form" lay-filter="layform">
		<div class="form-control form-content">
			...
			<div>
				...
				<div class="layui-form-item">
					<label class="layui-form-label">认证照片</label>
					<div class="layui-input-block">
						<button type="button" class="layui-btn" id="renzhengzhaopianupload-img" v-if="!detail.renzhengzhaopian">上传图片</button>
						<div class="layui-upload-list" v-if="detail.renzhengzhaopian">
							<img class="layui-upload-img" id="renzhengzhaopianimg-temp" :src="detail.renzhengzhaopian?detail.renzhengzhaopian.split(',')[0]:''">
							<p id="demoText"></p>
						</div>
					</div>
				</div>
 	...
 	$(function(){
		...
		layui.use('upload', function(){
			...
			var uploadInst = upload.render({
				elem: '#renzhengzhaopianupload-img'
				...
				,before: function(obj){
					...
					$('#renzhengzhaopianimg-temp').attr('src', result); //图片链接（base64）
					});
				}
				,done: function(res){
					//如果上传失败
					...
					return layer.msg('上传失败');
						...
						app.detail.renzhengzhaopian = baseurl+"/upload/"+res.file
