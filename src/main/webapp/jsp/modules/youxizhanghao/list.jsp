...
<body>
									...
									<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
										...
										<div class="col-sm-12">
											<div id="add-row_filter" class="dataTables_filter">
																																																																																																																																																										<label>游戏厂商</label>
																<select name="youxichangshang" id="youxichangshangSelect">
																																	<option value=" "> </option>
																																																						<option value="腾讯">腾讯</option>
																																					<option value="网易">网易</option>
																																					<option value="盛大网络">盛大网络</option>
																																					<option value="完美世界">完美世界</option>
																																					<option value="巨人网络">巨人网络</option>
																																					<option value="搜狐畅游">搜狐畅游</option>
																																					<option value="第九城市">第九城市</option>
																																					<option value="联众世界">联众世界</option>
																																					<option value="蓝洞">蓝洞</option>
																																					<option value="网龙">网龙</option>
																																					<option value="金山">金山</option>
																																																		</select>
																																																																																	<label>游戏分类</label>
																<select name="youxifenlei" id="youxifenleiSelect">
																																</select>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="maijiazhanghaoTh" class="sorting" onclick="sort('maijiazhanghao')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">卖家账号</th>
																																																			...
																																																			<th id="youxichangshangTh" class="sorting" onclick="sort('youxichangshang')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">游戏厂商</th>
	...
	<script >
		...
		function search(){
			searchForm = { key: ""};
																																													var youxichangshangIndex = document.getElementById("youxichangshangSelect").selectedIndex;
					var youxichangshangOptions = document.getElementById("youxichangshangSelect").options;
					var youxichangshangSelectedOption = youxichangshangOptions[youxichangshangIndex]
					if(youxichangshangSelectedOption.text != null &&  youxichangshangSelectedOption.text != ''){
						searchForm.youxichangshang = "%" + youxichangshangSelectedOption.text + "%";
					}		
																										var youxifenleiIndex = document.getElementById("youxifenleiSelect").selectedIndex;
					var youxifenleiOptions = document.getElementById("youxifenleiSelect").options;
					var youxifenleiSelectedOption = youxifenleiOptions[youxifenleiIndex]
					if(youxifenleiSelectedOption.text != null &&  youxifenleiSelectedOption.text != ''){
						searchForm.youxifenlei = "%" + youxifenleiSelectedOption.text + "%";
					}		
        ...
        function getDataList() {
			http("youxizhanghao/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
																																																										youxichangshang : searchForm.youxichangshang,	
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var youxichangshangCell  = document.createElement('td');

												  youxichangshangCell.innerHTML = item.youxichangshang; 
				  
                
													row.appendChild(youxichangshangCell);
			...
			btnGroup.setAttribute("class","form-button-action");
				...
				crossBtn.setAttribute("onclick","crossTable(" + item.id +",\"zhanghaojiaoyijilu\")");
				...
				crossBtn.setAttribute("onclick","crossTable(" + item.id +",\"sixinliaotianjilu\")");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("youxizhanghao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"youxizhanghao");
