...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">英雄联盟回复统计</h4>
	...
	<script >
		...
		$.ajax({ 
			type: "GET",
			url: baseUrl+"value/yingxionglianmenghuifu/"+xColumnName+'/'+yColumnName,
			data:{ },
		...
		function group(colName){
			$.ajax({ 
                type: "GET",
                url: baseUrl+"group/yingxionglianmenghuifu/"+colName,
             	data:{	tableName: "yingxionglianmenghuifu",
                    	columnName: colName
					 },
                beforeSend: function(xhr) {
                    xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
