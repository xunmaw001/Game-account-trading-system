				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/zhanghaojiaoyijilu/list.jsp">账号交易记录</a>
							</li>
						</ul>
					</div>
					<div class="row">
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "zhanghaojiaoyijilu/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("zhanghaojiaoyijilu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
