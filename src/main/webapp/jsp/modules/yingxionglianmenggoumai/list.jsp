...
<body>
	...
	<script >
        ...
        function getDataList() {
			http("yingxionglianmenggoumai/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item){
			...
			btnGroup.setAttribute("class","form-button-action");
				...
				crossBtn.setAttribute("onclick","crossTable(" + item.id +",\"yingxionglianmenghuanbang\")");
				...
				crossBtn.setAttribute("onclick","crossTable(" + item.id +",\"yingxionglianmengshensu\")");
			...
			function sh(){
				...
				httpJson("yingxionglianmenggoumai/update","POST",data,(res)=>{
					if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yingxionglianmenggoumai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"yingxionglianmenggoumai");
        ...
        function pay(id){
            window.sessionStorage.setItem('id',id);
			window.sessionStorage.setItem('tableName',"yingxionglianmenggoumai");
