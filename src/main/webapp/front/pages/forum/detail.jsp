	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">论坛表详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">论坛表详情</a></li>
				</ul>
			</div>
		</div>
	</section>
						...
						<div class="row">
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									<h4>帖子标题：{{detail.title}}</h4>
									<h4>帖子内容：{{detail.content}}</h4>
									<h4>父节点id：{{detail.parentid}}</h4>
									<h4>用户id：{{detail.userid}}</h4>
									<h4>用户名：{{detail.username}}</h4>
									<h4>是否关闭[关闭/开放]：{{detail.isdone}}</h4>
