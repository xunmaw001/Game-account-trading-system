			...
			<div class="shop-cart padding-tb">
			    <div class="container">
			        <div class="section-wrapper">
						...
						<h5 style="width: 100%;text-align: center;" onclick="javascript:window.location.href='./address-edit.jsp'" v-if="list.length==0">新增地址</h5>
	...
	<script type="text/javascript">
		var app = new Vue({
			...
			methods: {
				...
				onAddTap() {
					window.location.href = './address-edit.jsp'
				},
				onUpdateTap(item) {
					window.location.href = './address-edit.jsp?id=' + item.id
				}
			}
		})
		function pageFun(){
