...
<body>
									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="sixinshijian" v-model="ruleForm.sixinshijian" readonly>
																							</div>
											
										
																																																																																																																																																																																																																																																																																																																																																					<div class="form-group">
												<label>私信内容</label>
												<script id="sixinneirongEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var sixinneirongUe = UE.getEditor('sixinneirongEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" id="sixinneirong-input">
											</div>
																																																																																</form>
										</div>
									</div>
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
																																																										if(ruleForm.sixinneirong != null && ruleForm.sixinneirong != 'null' && ruleForm.sixinneirong != ''){
					var sixinneirongMes = '' + ruleForm.sixinneirong;
					var sixinneirongUeditor = UE.getEditor('sixinneirongEditor');
					sixinneirongUeditor.ready(function() {
						sixinneirongUeditor.setContent(sixinneirongMes);
						sixinneirongUeditor.setDisabled('fullscreen');
					});
				}
														}  
