...
<html>
			...
			<section class="page-header bg_img padding-tb">
				...
				<div class="container">
					<div class="page-header-content-area">
						<h4 class="ph-title">英雄联盟列表</h4>
						<ul class="agri-ul">
							<li><a href="../../index.jsp">首页</a></li>
							<li><a class="active">英雄联盟列表</a></li>
						</ul>
					</div>
				</div>
			</section>
							...
							<div class="col-lg-3 col-md-7 col-12">
							    <aside>
							        <div class="widget widget-search">
							            ...
							            <form @submit.prevent="searchshangpinbianhaoTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="shangpinbianhao" type="text" name="s" placeholder="请输入商品编号">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							            <form @submit.prevent="searchwangluodaquTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="wangluodaqu" type="text" name="s" placeholder="请输入网络大区">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							            <form @submit.prevent="searchyouxiqufuTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="youxiqufu" type="text" name="s" placeholder="请输入游戏区服">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							            <form @submit.prevent="searchqitaTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="qita" type="text" name="s" placeholder="请输入其他">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							            <form @submit.prevent="searchxiandingpifuTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="xiandingpifu" type="text" name="s" placeholder="请输入限定皮肤">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
	...
	<script type="text/javascript">
		var app = new Vue({
			...
			methods: {
				searchshangpinbianhaoTap(){
					this.page.page = 1
					this.searchname = "shangpinbianhao"
					this.searchval = this.shangpinbianhao
					this.getList(this.searchname, this.searchval)
				},
				searchwangluodaquTap(){
					this.page.page = 1
					this.searchname = "wangluodaqu"
					this.searchval = this.wangluodaqu
					this.getList(this.searchname, this.searchval)
				},
				searchyouxiqufuTap(){
					this.page.page = 1
					this.searchname = "youxiqufu"
					this.searchval = this.youxiqufu
					this.getList(this.searchname, this.searchval)
				},
				searchqitaTap(){
					this.page.page = 1
					this.searchname = "qita"
					this.searchval = this.qita
					this.getList(this.searchname, this.searchval)
				},
				searchxiandingpifuTap(){
					this.page.page = 1
					this.searchname = "xiandingpifu"
					this.searchval = this.xiandingpifu
					this.getList(this.searchname, this.searchval)
				},
				...
				getList(searchname, searchval) {
					return new Promise((resolve) => {
						goodsList('yingxionglianmeng',this.page.page, this.page.limit, searchname, searchval, (res) => {
							if (res.code == 0) {
