	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">英雄联盟换绑详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">英雄联盟换绑详情</a></li>
				</ul>
			</div>
		</div>
	</section>
						...
						<div class="row">
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									...
									<h4>登录账号：{{detail.dengluzhanghao}}</h4>
									<h4>登录密码：{{detail.denglumima}}</h4>
									<h4>绑定手机：{{detail.bangdingshouji}}</h4>
									<h4>换绑手机：{{detail.huanbangshouji}}</h4>
									<h4>换绑时间：{{detail.huanbangshijian}}</h4>
...
<script type="text/javascript">
	var app = new Vue({
		...
		async created() {
			...
			if(typeof frontmenus == "object"){
				frontmenus.forEach(item => {
					if(item.menutable == "yingxionglianmenghuanbang"){
		...
		methods: {
			...
			getDetail(id){
				return new Promise((resolve) => {
					goodsInfo('yingxionglianmenghuanbang',id, (res) => {
