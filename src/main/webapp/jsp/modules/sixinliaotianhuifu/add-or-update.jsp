				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/sixinliaotianhuifu/list.jsp">私信聊天回复</a>
							</li>
						</ul>
					</div>
					<div class="row">
									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<textarea id="yonghuliuyan" name="yonghuliuyan" class="form-control" rows="5">
												</textarea>
											</div>	
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("sixinliaotianhuifu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				...
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("sixinliaotianhuifu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						setSelectOption();
						// 设置图片src
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#shangpinbianhao").val(ruleForm.shangpinbianhao);	
																...
																$("#yonghuliuyan-input").val(ruleForm.yonghuliuyan);
									}
		//图片显示
		function showImg(){
																																															}		
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.yonghuliuyan != null && res.data.yonghuliuyan != ''){

															$("#yonghuliuyan-input").val(res.data.yonghuliuyan);
													}
											}
				});  
            }
