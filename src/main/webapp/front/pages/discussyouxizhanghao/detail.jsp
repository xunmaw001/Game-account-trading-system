	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">游戏账号评论表详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">游戏账号评论表详情</a></li>
				</ul>
			</div>
		</div>
	</section>
...
<script type="text/javascript">
	var app = new Vue({
		...
		async created() {
			...
			if(typeof frontmenus == "object"){
				frontmenus.forEach(item => {
					if(item.menutable == "discussyouxizhanghao"){
		...
		methods: {
			...
			getDetail(id){
				return new Promise((resolve) => {
					goodsInfo('discussyouxizhanghao',id, (res) => {
			...
			getComments(){
				commentList("discussyouxizhanghao", this.detail.id, (res) => {
					if(res&&res.code==0){
			...
			async onCommentTap(){
				...
				if(user){
					...
					addComment("discussyouxizhanghao", data, (res) => {
						if(res&&res.code==0){
							alert("评论成功")
							this.getComments()
						}
