									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="youxikuaqu" v-model="ruleForm.youxikuaqu" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>角色等级</label>
																								
																								<input id="jiaosedengji" v-model="ruleForm.jiaosedengji" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>角色职业</label>
																								
																								<input id="jiaosezhiye" v-model="ruleForm.jiaosezhiye" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>角色性别</label>
																								
																								<input id="jiaosexingbie" v-model="ruleForm.jiaosexingbie" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>封号记录</label>
																								
																								<input id="fenghaojilu" v-model="ruleForm.fenghaojilu" readonly>
																							</div>
