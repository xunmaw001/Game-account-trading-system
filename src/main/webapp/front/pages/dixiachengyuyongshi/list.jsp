			...
			<section class="page-header bg_img padding-tb">
				...
				<div class="container">
					<div class="page-header-content-area">
						<h4 class="ph-title">地下城与勇士列表</h4>
						<ul class="agri-ul">
							<li><a href="../../index.jsp">首页</a></li>
							<li><a class="active">地下城与勇士列表</a></li>
						</ul>
					</div>
				</div>
			</section>
							...
							<div class="col-lg-3 col-md-7 col-12">
							    <aside>
							        <div class="widget widget-search">
							            ...
							            <form @submit.prevent="searchyouxikuaquTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="youxikuaqu" type="text" name="s" placeholder="请输入游戏跨区">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
							            <form @submit.prevent="searchjiaosezhiyeTap" class="search-wrapper" style="margin-bottom: 20px;">
							                <input v-model="jiaosezhiye" type="text" name="s" placeholder="请输入角色职业">
							                <button type="submit"><i class="icofont-search-2"></i></button>
							            </form>
	...
	<script type="text/javascript">
		var app = new Vue({
			...
			methods: {
				...
				searchyouxikuaquTap(){
					this.page.page = 1
					this.searchname = "youxikuaqu"
					this.searchval = this.youxikuaqu
					this.getList(this.searchname, this.searchval)
				},
				searchjiaosezhiyeTap(){
					this.page.page = 1
					this.searchname = "jiaosezhiye"
					this.searchval = this.jiaosezhiye
					this.getList(this.searchname, this.searchval)
				},
				...
				getList(searchname, searchval) {
					return new Promise((resolve) => {
						goodsList('dixiachengyuyongshi',this.page.page, this.page.limit, searchname, searchval, (res) => {
							if (res.code == 0) {
