											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="maijiazhanghaoTh" class="sorting" onclick="sort('maijiazhanghao')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">卖家账号</th>
																																																			...
																																																			<th id="chushengnianyueTh" class="sorting" onclick="sort('chushengnianyue')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">出生年月</th>
																																																			<th id="qqzhanghaoTh" class="sorting" onclick="sort('qqzhanghao')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">qq账号</th>
																																																			...
																																																			<th id="jiatingdizhiTh" class="sorting" onclick="sort('jiatingdizhi')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">家庭地址</th>
																																																			
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">认证照片</th>
	...
	<script >
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var chushengnianyueCell  = document.createElement('td');

												  chushengnianyueCell.innerHTML = item.chushengnianyue;

				
													row.appendChild(chushengnianyueCell);
				
            				var qqzhanghaoCell  = document.createElement('td');

												 qqzhanghaoCell.innerHTML = item.qqzhanghao;

                
													row.appendChild(qqzhanghaoCell);
            				...
            				var jiatingdizhiCell  = document.createElement('td');

												 jiatingdizhiCell.innerHTML = item.jiatingdizhi;

                
													row.appendChild(jiatingdizhiCell);
				
            				var renzhengzhaopianCell  = document.createElement('td');

								                  var renzhengzhaopianImg = document.createElement('img');
				  renzhengzhaopianImg.setAttribute('src',item.renzhengzhaopian);
				  renzhengzhaopianImg.setAttribute('height','100px');
				  renzhengzhaopianImg.setAttribute('width','100px');
				  renzhengzhaopianCell.appendChild(renzhengzhaopianImg);

				
													row.appendChild(renzhengzhaopianCell);
			...
			function sh(){
				...
				httpJson("maijia/update","POST",data,(res)=>{
					if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("maijia/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"maijia");
