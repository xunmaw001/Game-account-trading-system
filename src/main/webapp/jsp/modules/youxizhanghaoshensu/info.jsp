...
<body>
									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="goumairiqi" v-model="ruleForm.goumairiqi" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="shensushijian" v-model="ruleForm.shensushijian" readonly>
																							</div>
																					...
																					<div class="form-group">
																																																																																																																																																																																																																																																																																																																																																																																																																																																																													...
																																																																																																																																																																																																																																																																																																																																																																																																																																																																													<div class="form-group">
												<label>申诉说明</label>
												<script id="shensushuomingEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var shensushuomingUe = UE.getEditor('shensushuomingEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" id="shensushuoming-input">
											</div>
																																																																																																																																													<div class="form-group">
												<label>审核回复</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "youxizhanghaoshensu/info/" + id,
		...
		// 填充富文本框
		function setContent(){
																																																																												if(ruleForm.shensushuoming != null && ruleForm.shensushuoming != 'null' && ruleForm.shensushuoming != ''){
					var shensushuomingMes = '' + ruleForm.shensushuoming;
					var shensushuomingUeditor = UE.getEditor('shensushuomingEditor');
					shensushuomingUeditor.ready(function() {
						shensushuomingUeditor.setContent(shensushuomingMes);
						shensushuomingUeditor.setDisabled('fullscreen');
					});
				}
