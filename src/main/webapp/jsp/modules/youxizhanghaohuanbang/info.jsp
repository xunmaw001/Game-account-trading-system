									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="dengluzhanghao" v-model="ruleForm.dengluzhanghao" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>登录密码</label>
																								
																								<input id="denglumima" v-model="ruleForm.denglumima" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>绑定手机</label>
																								
																								<input id="bangdingshouji" v-model="ruleForm.bangdingshouji" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>换绑手机</label>
																								
																								<input id="huanbangshouji" v-model="ruleForm.huanbangshouji" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="huanbangshijian" v-model="ruleForm.huanbangshijian" readonly>
																							</div>
