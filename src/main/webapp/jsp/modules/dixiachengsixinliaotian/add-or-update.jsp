				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/dixiachengsixinliaotian/list.jsp">地下城私信聊天</a>
							</li>
						</ul>
					</div>
					<div class="row">
									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<textarea id="sixinneirong" name="sixinneirong" class="form-control" rows="5">
												</textarea>
											</div>	
											<div class="form-group">
												<label>私信时间</label>
												
												<div id="sixinshijianDate" class="input-append date form_datetime">
													<input id="sixinshijian-input" name="sixinshijian" size="20" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "dixiachengsixinliaotian/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("dixiachengsixinliaotian/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				...
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("dixiachengsixinliaotian/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						setSelectOption();
						// 设置图片src
		...
		function dateTimePick(){
			$.fn.datetimepicker.dates['zh-CN'] = { 
		            ...
		            meridiem: ["上午", "下午"]
																																																																			...
																																																																			$("#sixinshijianDate").datetimepicker({ 
					autoclose: true,
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#maijiazhanghao").val(ruleForm.maijiazhanghao);	
																...
																$("#sixinneirong-input").val(ruleForm.sixinneirong);
																$("#sixinshijian-input").val(ruleForm.sixinshijian);
									}
		//图片显示
		function showImg(){
																																																																				}		
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.sixinneirong != null && res.data.sixinneirong != ''){

															$("#sixinneirong-input").val(res.data.sixinneirong);
													}
												if(res.data != null && res.data != '' && res.data.sixinshijian != null && res.data.sixinshijian != ''){

															$("#sixinshijian-input").val(res.data.sixinshijian);
								$('#sixinshijianFileName').val(res.data.sixinshijian)
													}
											}
				});  
            }
