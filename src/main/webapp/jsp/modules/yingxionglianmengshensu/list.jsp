...
<body>
	...
	<script >
		...
		var tableName = "yingxionglianmengshensu";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("yingxionglianmengshensu/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item){
			...
			function shDialog(id){
				$("#shId").attr("value",id);
				http("yingxionglianmengshensu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
			...
			function sh(){
				...
				httpJson("yingxionglianmengshensu/update","POST",data,(res)=>{
					if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yingxionglianmengshensu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("yingxionglianmengshensu" + colName,"GET",{
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"yingxionglianmengshensu");
