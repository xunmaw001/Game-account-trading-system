				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/dixiachengzhanghaogoumai/list.jsp">地下城账号购买</a>
							</li>
						</ul>
					</div>
					<div class="row">
									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<input id="jiaosezhiye" name="jiaosezhiye" class="form-control" placeholder="角色职业">
												</div>	
											<div class="form-group">
												<label>账号价格</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "dixiachengzhanghaogoumai/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("dixiachengzhanghaogoumai/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#maijiazhanghao").val(ruleForm.maijiazhanghao);	
																...
																$("#jiaosezhiye").val(ruleForm.jiaosezhiye);	
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.jiaosezhiye != null && res.data.jiaosezhiye != ''){
															...
															$("#jiaosezhiye").val(res.data.jiaosezhiye);
													}
