...
public class DixiachengzhanghaohuanbangEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DixiachengzhanghaohuanbangEntity() {
		
	}
	
	public DixiachengzhanghaohuanbangEntity(T t) {
		try {
