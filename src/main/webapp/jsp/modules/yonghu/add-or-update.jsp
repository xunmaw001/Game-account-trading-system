									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<input id="dianhuahaoma" name="dianhuahaoma" class="form-control" placeholder="电话号码">
												</div>	
											<div class="form-group">
												<label>邮箱号码</label>
												
												<input id="youxianghaoma" name="youxianghaoma" class="form-control" placeholder="邮箱号码">
												</div>	
											<div class="form-group">
												<label>身份证号</label>
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#yonghuming").val(ruleForm.yonghuming);	
																...
																$("#youxianghaoma").val(ruleForm.youxianghaoma);	
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
								...
								$('#chushengnianyueFileName').val(res.data.chushengnianyue)
												...
												if(res.data != null && res.data != '' && res.data.youxianghaoma != null && res.data.youxianghaoma != ''){

															$("#youxianghaoma").val(res.data.youxianghaoma);
													}
