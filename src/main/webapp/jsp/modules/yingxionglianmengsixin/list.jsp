...
<body>
	...
	<script >
		...
		var tableName = "yingxionglianmengsixin";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("yingxionglianmengsixin/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item){
			...
			btnGroup.setAttribute("class","form-button-action");
				...
				crossBtn.setAttribute("onclick","crossTable(" + item.id +",\"yingxionglianmenghuifu\")");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yingxionglianmengsixin/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("yingxionglianmengsixin" + colName,"GET",{
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"yingxionglianmengsixin");
