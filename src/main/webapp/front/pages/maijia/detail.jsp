	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">卖家详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">卖家详情</a></li>
				</ul>
			</div>
		</div>
	</section>
						...
						<div class="row">
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									...
									<h4>性别：{{detail.xingbie}}</h4>
									<h4>出生年月：{{detail.chushengnianyue}}</h4>
									<h4>qq账号：{{detail.qqzhanghao}}</h4>
									<h4>联系电话：{{detail.lianxidianhua}}</h4>
									<h4>电子邮箱：{{detail.dianziyouxiang}}</h4>
