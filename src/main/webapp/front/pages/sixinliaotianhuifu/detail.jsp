	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">私信聊天回复详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">私信聊天回复详情</a></li>
				</ul>
			</div>
		</div>
	</section>
						...
						<div class="row">
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									...
									<h4>用户留言：{{detail.yonghuliuyan}}</h4>
...
<script type="text/javascript">
	var app = new Vue({
		...
		async created() {
			...
			if(typeof frontmenus == "object"){
				frontmenus.forEach(item => {
					if(item.menutable == "sixinliaotianhuifu"){
		...
		methods: {
			...
			getDetail(id){
				return new Promise((resolve) => {
					goodsInfo('sixinliaotianhuifu',id, (res) => {
