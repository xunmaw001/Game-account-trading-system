...
<body>
									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="youxifenlei" v-model="ruleForm.youxifenlei" readonly>
																							</div>
																					...
																					<div class="form-group">
																																																																																																																																													...
																																																																																																																																													<div class="form-group">
												<label>卖家回复</label>
												<script id="maijiahuifuEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var maijiahuifuUe = UE.getEditor('maijiahuifuEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" id="maijiahuifu-input">
											</div>
																																																																																																					<div class="form-group">
												<label>用户留言</label>
												<script id="yonghuliuyanEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var yonghuliuyanUe = UE.getEditor('yonghuliuyanEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" id="yonghuliuyan-input">
											</div>
																																								</form>
										</div>
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "sixinliaotianhuifu/info/" + id,
		...
		// 填充富文本框
		function setContent(){
																												if(ruleForm.maijiahuifu != null && ruleForm.maijiahuifu != 'null' && ruleForm.maijiahuifu != ''){
					var maijiahuifuMes = '' + ruleForm.maijiahuifu;
					var maijiahuifuUeditor = UE.getEditor('maijiahuifuEditor');
					maijiahuifuUeditor.ready(function() {
						maijiahuifuUeditor.setContent(maijiahuifuMes);
						maijiahuifuUeditor.setDisabled('fullscreen');
					});
				}
																			if(ruleForm.yonghuliuyan != null && ruleForm.yonghuliuyan != 'null' && ruleForm.yonghuliuyan != ''){
					var yonghuliuyanMes = '' + ruleForm.yonghuliuyan;
					var yonghuliuyanUeditor = UE.getEditor('yonghuliuyanEditor');
					yonghuliuyanUeditor.ready(function() {
						yonghuliuyanUeditor.setContent(yonghuliuyanMes);
						yonghuliuyanUeditor.setDisabled('fullscreen');
					});
				}
								}  
