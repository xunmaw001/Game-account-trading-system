		...
		<div class="form-control form-content">
			...
			<div>
				...
				<div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-block">
						<textarea v-model="detail.maijiahuifu" placeholder="请输入卖家回复" class="layui-textarea"></textarea>
					</div>
				</div>
				<div class="layui-form-item layui-form-text">
					<label class="layui-form-label">用户回复</label>
					<div class="layui-input-block">
						<textarea v-model="detail.yonghuhuifu" placeholder="请输入用户回复" class="layui-textarea"></textarea>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	var app = new Vue({
		...
		methods: {
			...
			onConfirmTap(){
				addFun("yingxionglianmenghuifu", this.detail, (res) => {
					if(res&&res.code==0){
						alert("提交成功")
						window.history.go(-1)
					}
