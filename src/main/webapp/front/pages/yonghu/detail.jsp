	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">用户详情</h4>
				<ul class="agri-ul">
					<li><a href="../../index.jsp">首页</a></li>
					<li><a class="active">用户详情</a></li>
				</ul>
			</div>
		</div>
	</section>
						...
						<div class="row">
							<div class="col-md-6 col-12">
								<div class="post-content" v-if="detail">
									...
									<h4>年龄：{{detail.nianling}}</h4>
									<h4>出生年月：{{detail.chushengnianyue}}</h4>
									<h4>qq账号：{{detail.qqzhanghao}}</h4>
									<h4>电话号码：{{detail.dianhuahaoma}}</h4>
									<h4>邮箱号码：{{detail.youxianghaoma}}</h4>
									<h4>身份证号：{{detail.shenfenzhenghao}}</h4>
									<h4>家庭地址：{{detail.jiatingdizhi}}</h4>
